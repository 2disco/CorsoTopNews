...
class Todisco_News_Adminhtml_CategoryController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction()
    {
        ...
        if($this->getRequest()->getParam('category_id')) {
            ...
            $model = Mage::getModel('todisco_news/category');
        }
    ...
    {
        //load object
        $category = Mage::getModel('todisco_news/category')->load($this->getRequest()->getParam('category_id'));
    ...
    //        echo '<br>category id: ' . $this->getRequest()->getParam('category_id');
    }
